export function renderFarmers(product) {
    ...
    locationParagraph.classList.add('card-text', 'text-muted', 'text-center', 'mb-1');
    const locationIcon = document.createElement('i');
    locationIcon.classList.add('bi', 'bi-geo-alt-fill');
    const locationText = document.createTextNode(' Ubicación: ' + product.location);
    locationParagraph.appendChild(locationIcon);
    locationParagraph.appendChild(locationText);
  
    
    const priceContainer = document.createElement('div');
    priceContainer.classList.add('d-flex', 'justify-content-center', 'align-items-center', 'mb-3');
